...
public class Sobel {
    ...
    private static int filename(String filename) {
        int i = 0;
    ...
    public static void main(String[] args) {
        String[] foo = {"pj1/reggie.tiff", "6", "4534534"};
        args = foo;
        if (args.length == 0) {
