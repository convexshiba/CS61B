...
public class Homework6Test {
    ...
    public static void main(String[] args) {
        ...
        // from here.
        System.out.println("n = " + numBoards + " N = " + table.hashSize);
        System.out.println("Actual number of collisions: " + table.collision);
        System.out.printf("Expected number of collisions: %.2f%n", HashTableChained.expectedRate(numBoards, table.size()));
